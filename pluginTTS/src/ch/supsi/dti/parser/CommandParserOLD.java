...
public class CommandParserOLD implements CommandParserConstants {
	...
	final public String selectBinary(Token t) throws ParseException {
		...
		ret = identifier(id);
		{
			...
			case "package":
				...
				IPackageFragmentRoot packageRoot = javaProject.getPackageFragmentRoot();
				IPackageFragment thePackage = packageRoot.getPackageFragment(ret);
				packageExplorer.setFocus();
	...
	// Mine
	private JavaProject checkSelectionAndReturnProject() throws ProjectNotFoundException{
